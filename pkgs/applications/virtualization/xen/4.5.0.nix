...
let
  ...
  xenConfig = {
    ...
    firmwareGits =
      [ # tag 1.7.5
        { git = { name = "seabios";
                  url = http://xenbits.xen.org/seabios.git;
        ...
        { git = { name = "ovmf";
                  url = http://xenbits.xen.org/ovmf.git;
    ...
    toolsGits =
      [ # tag qemu-xen-4.5.0
        { git = { name = "qemu-xen";
                  url = http://xenbits.xen.org/qemu-upstream-4.5-testing.git;
        ...
        { git = { name = "qemu-xen-traditional";
                  url = http://xenbits.xen.org/qemu-xen-4.5-testing.git;
